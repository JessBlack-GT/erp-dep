...
describe('Frontend Features', () => {
  const features = ['auth', 'customers', 'suppliers'];
...
describe('Future features — not implemented, not credited as passing', () => {
  for (const feature of ['dashboard', 'products', 'inventory', 'sales', 'purchases', 'finance', 'human-resources', 'reports', 'notifications', 'settings']) {
